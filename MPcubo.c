/* Versão 3.0 - Gerar cubo de coerência dos parâmetros do CRS zero offset (RN, RNIP, BETA)

IMPORTANTE: Esta versão utiliza a computação paralela para aumentar o desempenho
...
Programador: Rodolfo A. C. Neves 15/04/2019 (1.0 - original)
	     ...
	     Rodolfo A. C. Neves 26/05/2019 (3.0) Computação paralela
